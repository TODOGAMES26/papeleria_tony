...
<head>
    ...
    <style>
        ...
        .btn-save { background: #27ae60; color: white; border: none; padding: 10px; width: 100%; border-radius: 5px; cursor: pointer; font-weight: 600; }
    </style>
</head>
<body>
    <div class="form-box">
        ...
        <form action="guardar_edicion.php" method="POST">
            ...
            Stock: <input type="number" name="stock" value="<?php echo $producto['stock']; ?>" required>
